...
class BarricadeSingleAgentEnv(gym.Env):
    ...
    def step(self, action: int):
        ...
        prev_learner_path = self.game.shortest_path_length(0)
        prev_opponent_path = self.game.shortest_path_length(1)
    ...
    def _shaped_reward(self, prev_learner_path: int | None, prev_opponent_path: int | None) -> float:
        if not self.shaped_reward:
            return 0.0
        learner_path = self.game.shortest_path_length(0)
        opponent_path = self.game.shortest_path_length(1)
